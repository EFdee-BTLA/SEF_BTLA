...
var config float						FlashbangGrenadeDelayTime;
var config float						FlashbangGrenadeDelayTimeHelmetAndGoggles;
...
latent function FinishUpThrowBehavior()
{
	if (CurrentThrowGrenadeGoal != None)
	{
        ...
        if (CurrentThrowGrenadeGoal.GrenadeSlot == EquipmentSlot.Slot_Flashbang)
			...
			{
				PostGrenadeThrowDelayTime = FlashbangGrenadeDelayTimeHelmetAndGoggles;
			}
		    else
			{
				PostGrenadeThrowDelayTime = FlashbangGrenadeDelayTime;
			}
